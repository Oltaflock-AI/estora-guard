    ...
    Tables: {
      ...
      contracts: {
        Row: {
          ...
          additional_deposit_amount: number | null;
          seller_assist_amount: number | null;
          mortgage_term_years: number | null;
          pre_approval_letter_date: string | null;
          inspection_contingency_days: number | null;
          inspection_deadline: string | null;
          home_inspection_elected: boolean;
          wood_destroying_insect_inspection_elected: boolean;
          radon_inspection_elected: boolean;
          mold_inspection_elected: boolean;
          water_quality_inspection_elected: boolean;
          septic_inspection_elected: boolean;
          lead_based_paint_inspection_elected: boolean;
          boundary_survey_elected: boolean;
          settlement_time: string | null;
          settlement_location: string | null;
          pa_realty_transfer_tax_seller: number | null;
          pa_realty_transfer_tax_buyer: number | null;
          local_transfer_tax: number | null;
          water_source: string | null;
          sewage_disposal: string | null;
          megan_law_notice_acknowledged: boolean;
          notes: string | null;
